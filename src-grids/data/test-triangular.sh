...
GRIDSHORTHAND=triangular
GRID=triangular
RULEFILE=rules-tri-gen.txt
...
# this one needs a lot of constraints!
echo $GRIDSHORTHAND $PROBLEM $RULESHORTHAND
time ../grid-cplex.exe --$GRID --$PROBLEM --rules $RULEFILE $RULES --maxconstraints 5000000 >& output-$GRID-$PROBLEM-$RULESHORTHAND.txt
