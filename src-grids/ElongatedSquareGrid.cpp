...
int SquareGrid::reserveNewFace()
{
	int f_index = this->max_facial_index;
	(this->max_facial_index)++;

	this->fd[f_index] = 4;
	this->f[f_index] = 4 * f_index;
	this->max_f_value = 4 * (f_index + 1);
	this->fo[f_index] = 0;
...
int SquareGrid::reserveNewVertex()
{
	int v_index = this->max_vertex_index;
	(this->max_vertex_index)++;

	this->vd[v_index] = 4;
	this->v[v_index] = 4 * v_index;

	this->max_v_value = 4 * (v_index + 1);
	this->vo[v_index] = 0;
...
SquareGrid::SquareGrid(int max_magnitude)
{
	...
	this->lengthenFArrays(num_faces, 4 * num_faces);
	...
	for ( int i = 0; i < num_faces; i++ )
	{
		...
		this->ffe[this->f[findex] + 0] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y - 1, 2*max_coord, xy_face);
		this->ffe[this->f[findex] + 1] = IN_BOUNDS_OR_NULL(max_coord + x + 1, max_coord + y + 0, 2*max_coord, xy_face);
		this->ffe[this->f[findex] + 2] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y + 1, 2*max_coord, xy_face);
		this->ffe[this->f[findex] + 3] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y + 0, 2*max_coord, xy_face);
		...
		this->fve[this->f[findex] + 3] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y + 1, 2*max_coord, xy_vertex);

		this->fbe[2 * this->f[findex] + 1] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y - 1, 2*max_coord, xy_face);
		this->fbe[2 * this->f[findex] + 3] = IN_BOUNDS_OR_NULL(max_coord + x + 1, max_coord + y + 0, 2*max_coord, xy_face);
		this->fbe[2 * this->f[findex] + 5] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y + 1, 2*max_coord, xy_face);
		this->fbe[2 * this->f[findex] + 7] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y + 0, 2*max_coord, xy_face);
		...
		this->fbe[2 * this->f[findex] + 6] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y + 1, 2*max_coord, xy_vertex);
	}
	...
	for ( int i = 0; i < num_verts; i++ )
	{
		...
		this->vve[this->v[vindex] + 3] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y + 0, 2*max_coord, xy_vertex);

		this->vfe[this->v[vindex] + 0] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y - 1, 2*max_coord, xy_face);
		this->vfe[this->v[vindex] + 1] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y - 1, 2*max_coord, xy_face);
		this->vfe[this->v[vindex] + 2] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y + 0, 2*max_coord, xy_face);
		this->vfe[this->v[vindex] + 3] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y + 0, 2*max_coord, xy_face);
		...
		this->vbe[2 * this->v[vindex] + 7] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y + 0, 2*max_coord, xy_vertex);

		this->vbe[2 * this->v[vindex] + 0] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y - 1, 2*max_coord, xy_face);
		this->vbe[2 * this->v[vindex] + 2] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y - 1, 2*max_coord, xy_face);
		this->vbe[2 * this->v[vindex] + 4] = IN_BOUNDS_OR_NULL(max_coord + x + 0, max_coord + y + 0, 2*max_coord, xy_face);
		this->vbe[2 * this->v[vindex] + 6] = IN_BOUNDS_OR_NULL(max_coord + x - 1, max_coord + y + 0, 2*max_coord, xy_face);
	}
